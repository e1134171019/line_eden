...
def test_long_day_program_clause_still_excludes_evening_student() -> None:
...
def test_day_and_evening_groups_in_same_clause_are_not_exclusive() -> None:
...
def test_preference_language_does_not_become_exclusive_requirement() -> None:
